    ...
    pc: [
      {
        ...
        // youtubeVideos: [],
        description:
          'The development of this project began in September 2017. For around four years, I worked alone on programming the basic mechanics that would become a Kingdom Hearts game:</p><ul><li>Its combat system, including abilities, combos, levelling up and movement.</li><li>A system for grabbing onto building ledges.</li><li>Interaction with enemies and environmental elements.</li><li>A dialogue system with flags.</li><li>The various menus, including the command menu, main menu and various pause menus depending on the situation.</li><li>Pre-rendered cutscenes and their integration into the game.</li><li>Remaking assets exclusive to 358/2 Days, such as the boss Xion.</li></ul><p>However, my good friends Keytotruth and 13th Vessel and I continued to work hard for another five years or so, seeing that the game could be completed with excellent results. During that time, we made huge strides in filling the gaps in the core content and refined every single aspect to make the most of the various systems created.</p><p><br>Alongside the programming work and reverse engineering of other official games in the series, and coordinating with my colleagues, I also liaised with artists and translators from around the world. Finally, we collaborated with the team at Ecos del Doblaje to produce a full Spanish dub for our game.</p><p><br>From one fan to another, I present my magnum opus to date. I hope you enjoy it as much as we enjoyed making it.',
        features: [
      ...
      },
      {
        ...
        name: 'Delusion',
        shortDescription:
          'This psychological horror game challenges the perception of reality. It was made as a school project in Unreal Engine 3, with the objective of building my own 3D assets from scratch and creating a simple yet functional game.',
        downloadUrl:
      ...
      },
      {
        ...
        shortDescription:
          'This is a zombie game that was developed using a custom-made 2D graphics engine. The aim of the game is to kill all the zombies before they can infect everyone.',
        downloadUrl:

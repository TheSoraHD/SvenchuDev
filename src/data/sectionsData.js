  ...
  games: {
    pc: [
        ...
        changelog: [
          {
            version: '1.0.0',
            date: '2021-04-11',
            changes: [{ en: 'Official release', es: 'Lanzamiento oficial' }],
          },
        ],
      },
      {
        ...
        features: [
          { en: 'Color changing mechanics', es: 'Mecánicas de cambio de color' },
          { en: 'Vibrant visual style', es: 'Estilo visual vibrante' },
          { en: 'Short and intense gameplay', es: 'Jugabilidad corta e intensa' },
        ],
        downloadInfo: {
          version: '1.0.0',
          size: '576 MB',
      ...
      },
      {
        ...
        features: [
          { en: 'Time-stopping mechanics', es: 'Mecánicas de detención del tiempo' },
          {
            en: 'Recreation of classic Contra levels',
            es: 'Recreación de los niveles clásicos de Contra',
          },
          { en: 'Bullet hell boss fight', es: 'Combate final de bullet hell' },
        ],
        downloadInfo: {
          version: '1.0.0',
          size: '39.5 MB',
      ...
      },
      {
        ...
        downloadInfo: {
          ...
          installation: [
            ...
            {
              en: "Run Binaries/UnEulaLite and accept UDK's EULA.",
              es: 'Ejecuta Binaries/UnEulaLite y acepta la EULA de UDK.',
            },
            { en: 'Run the game!', es: '¡Ejecuta el juego!' },
          ],
        },
        changelog: [
          {
            ...
            changes: [
              {
                en: 'Added UnEulaLite, making it playable on modern systems',
                es: 'Se añadió UnEulaLite, permitiendo jugarlo en sistemas modernos',
              },
              {
                en: 'Added compatibility with Ultrawide monitors',
                es: 'Se añadió compatibilidad con monitores ultrawide',
              },
              { en: 'Changed website', es: 'Se cambió la página web' },
            ],
          },
          {
            version: '0.1 (Prototype)',
            date: '2014-01-12',
            changes: [{ en: 'Private release', es: 'Lanzamiento privado' }],
          },
        ],
      },
      {
        ...
        // youtubeVideos: [],
        description: {
          en: "<p>Built in 2016 as a purely self-directed learning exercise, Sanic: The Zombie Game was developed by following <em>MakingGamesWithBen</em>'s Advanced C++/Graphics Tutorials — a 65-video series on advanced C++ and OpenGL — with the goal of understanding how to build a custom 2D game engine from the ground up.</p><p>The result is a top-down shooter where zombies spread instantly by contact: infected civilians turn immediately, and a single touch kills the player. The only personal touch added beyond the course material was the player character — rendered as the Sanic meme, making them instantly distinguishable from the civilians and undead filling the screen.</p><p>Straightforward in scope by design, the project was never about the game itself but about what building it taught: working directly with OpenGL, structuring an engine architecture, and developing a clearer understanding of what happens beneath the surface of higher-level tools.</p>",
          es: '<p>Desarrollado en 2016 como ejercicio de aprendizaje autodidacta, Sanic: The Zombie Game fue creado siguiendo los tutoriales avanzados de C++/Gráficos de <em>MakingGamesWithBen</em> —una serie de 65 vídeos sobre C++ avanzado y OpenGL— con el objetivo de entender cómo construir un motor de juego 2D propio desde cero.</p><p>El resultado es un shooter top-down donde los zombis se propagan al instante por contacto: los civiles infectados se convierten de inmediato, y un solo toque mata al jugador. El único toque personal añadido más allá del material del curso fue el personaje del jugador —representado como el meme de Sanic, haciéndolo inmediatamente distinguible de los civiles y los no muertos que llenan la pantalla.</p><p>Siendo lo más simplista posible desde su concepción, el proyecto nunca trató sobre el juego en sí, sino sobre lo que aprendí a medida que lo desarrollaba: trabajar directamente con OpenGL, estructurar una arquitectura de motor y obtener una comprensión más clara de lo que ocurre bajo la superficie de las herramientas de más alto nivel.</p>',
        },
        features: [
          { en: 'Multiple weapons', es: 'Múltiples armas' },
          { en: 'Zoomable camera', es: 'Cámara con zoom' },
          { en: 'Pathfinding AI', es: 'IA con pathfinding' },
        ],
        downloadInfo: {
          version: '0.1',
          size: '6.74 MB',
          requirements: 'Custom C++/OpenGL Engine',
          installation: [{ en: 'Extract the file', es: 'Extrae el archivo' }],
        },
        changelog: [
          {
            version: '0.1',
            date: '2016-08-05',
            changes: [{ en: 'Release', es: 'Lanzamiento' }],
          },
        ],
      },
    ],
    gba: [
      {
        ...
        downloadInfo: {
          ...
          installation: [{ en: 'Play the ROM', es: 'Juega la ROM' }],
        },
        changelog: [
          {
            version: '1.0.0',
    ...
    nds: [
      {
        ...
        features: [
          {
            en: "Use the buttons closer to the player's hands to control the clock.",
            es: 'Usa los botones más cercanos a las manos del jugador para controlar el reloj.',
          },
          { en: 'Customizable time settings', es: 'Ajustes de tiempo personalizables' },
          { en: 'Simple and intuitive interface', es: 'Interfaz simple e intuitiva' },
        ],
        changelog: [
          {
            version: '1.0.0',
            date: '2012-04-12',
            changes: [
              { en: 'Private release.', es: 'Lanzamiento privado.' },
              {
                en: 'If you would like it to be public, please let me know!',
                es: '¡Si quieres que sea público, házmelo saber!',
              },
            ],
          },
        ],
        ...
        changelog: [
          {
            ...
            date: '2011/08/23',
            changes: [
              { en: 'Non-functional ROM.', es: 'ROM no funcional.' },
              {
                en: 'If you would like it to be properly made, please let me know!',
                es: '¡Si quieres que se haga correctamente, házmelo saber!',
              },
            ],
          },
        ],
      },
      {
        ...
        features: [
          { en: 'Track high scores', es: 'Registra las puntuaciones máximas' },
          { en: 'Multiplayer on the same device', es: 'Multijugador en el mismo dispositivo' },
        ],
        downloadInfo: {
          version: '1.0.0',
          size: '174 KB',
  ...
  translations: [
    {
      ...
      features: [
        {
          en: 'Almost complete translation of all dialogues',
          es: 'Traducción casi completa de todos los diálogos',
        },
        { en: 'Translated menus and interfaces', es: 'Menús e interfaces traducidos' },
        {
          en: "Compatible with PSP's exclusive multiplayer mode",
          es: 'Compatible con el modo multijugador exclusivo de PSP',
        },
      ],
      downloadInfo: {
        version: '1.0',
        ...
        installation: [
          {
            en: 'Extract UMDGen, and open the original ISO file of the game with it',
            es: 'Extrae UMDGen y abre el archivo ISO original del juego con él',
          },
          {
            en: 'Replace DAT files with the ones included in the translation patch',
            es: 'Reemplaza los archivos DAT con los incluidos en el parche de traducción',
          },
          {
            en: 'Save the modified ISO file and use it with a compatible emulator or on a modded PSP/PSVita',
            es: 'Guarda el archivo ISO modificado y úsalo con un emulador compatible o en una PSP/PSVita modificada',
          },
        ],
      },
      changelog: [
    ...
    },
    {
      ...
      features: [
        {
          en: 'Translation faithful to the USA localization.',
          es: 'Traducción fiel a la localización de EE. UU.',
        },
        {
          en: 'Support for latest version and DLCs.',
          es: 'Compatible con la última versión y DLCs.',
        },
      ],
      downloadInfo: {
        version: '1.0.0',
        ...
        installation: [
          { en: 'Install the PKG file', es: 'Instala el archivo PKG' },
          { en: 'Apply the translation patch', es: 'Aplica el parche de traducción' },
        ],
      },
    },
  ],
  mods: [
    {
      ...
      features: [
        { en: 'Full dubbing in Castilian Spanish', es: 'Doblaje completo en castellano' },
        {
          en: 'Resubbed cutscenes to go along with the Spanish voices',
          es: 'Cinemáticas resubtituladas para acompañar las voces en español',
        },
        { en: 'Compatible with all versions', es: 'Compatible con todas las versiones' },
      ],
      downloadInfo: {
        version: '1.3',
        size: '2.8 GB',
        ...
        installation: [
          { en: 'Use OpenKH Mod Manager', es: 'Usa OpenKH Mod Manager' },
          {
            en: 'Install the mod "TheSoraHD/KH2SpanishMix"',
            es: 'Instala el mod "TheSoraHD/KH2SpanishMix"',
          },
          { en: 'Build only, then play!', es: '¡"Build only" y a jugar!' },
        ],
      },
      changelog: [
        {
          version: '1.3',
          date: '2024-05-23',
          changes: [{ en: 'Bug fixes', es: 'Corrección de errores' }],
        },
        {
          version: '1.2',
          date: '2022-05-27',
          changes: [
            {
              en: 'Mod compatibility with other mods improved',
              es: 'Compatibilidad del mod con otros mods mejorada',
            },
            {
              en: 'More FM-exclusive cutscenes dubbed',
              es: 'Más cinemáticas exclusivas de FM dobladas',
            },
          ],
        },
        {
        ...
        },
        {
          version: '1.0',
          date: '2021-06-27',
          changes: [{ en: 'Fully dubbed gameplay', es: 'Gameplay completamente doblado' }],
        },
        {
          version: '0.95',
          date: '2021-06-02',
          changes: [{ en: 'Fully dubbed cutscenes', es: 'Cinemáticas completamente dobladas' }],
        },
        {
          version: '0.9',
          date: '2021-05-29',
          changes: [{ en: 'First version released', es: 'Primera versión lanzada' }],
        },
      ],
    },
    {
      ...
      name: {
        ...
        es: 'KINGDOM HEARTS 2: Esencia Intangible de Sephiroth',
      },
      shortDescription: {
      ...
      downloadInfo: {
        ...
        installation: [
          { en: 'Use OpenKH Mod Manager', es: 'Usa OpenKH Mod Manager' },
          {
            en: 'Install the mod "TheSoraHD/KH2SephirothAS"',
            es: 'Instala el mod "TheSoraHD/KH2SephirothAS"',
          },
          { en: 'Build only, then play!', es: '¡"Build only" y a jugar!' },
        ],
      },
      changelog: [
        {
          ...
          date: '2022-06-15',
          changes: [
            { en: '100% compatible with KH Re:Fined', es: '100% compatible con KH Re:Fined' },
          ],
        },
        {
          version: '1.0',
    ...
    },
    {
      ...
      downloadInfo: {
        ...
        installation: [
          { en: 'Use OpenKH Mod Manager', es: 'Usa OpenKH Mod Manager' },
          {
            en: 'Install the mod "TheSoraHD/XemnasDeletedQuotes"',
            es: 'Instala el mod "TheSoraHD/XemnasDeletedQuotes"',
          },
          { en: 'Build only, then play!', es: '¡"Build only" y a jugar!' },
        ],
      },
    ...
    },
    {
      ...
      features: [
        {
          en: '99% in-game cutscenes voices that existed previously in the PSP version!',
          es: '¡El 99% de las voces de cinemáticas del juego que existían previamente en la versión de PSP!',
        },
        {
          en: 'Compatible only with the latest version of the game.',
          es: 'Compatible solo con la última versión del juego.',
        },
      ],
      downloadInfo: {
        version: '0.2',
        ...
        installation: [
          {
            en: 'Create a ~mods folder in the game directory',
            es: 'Crea una carpeta ~mods en el directorio del juego',
          },
          {
            en: 'Extract the mod files into the ~mods folder',
            es: 'Extrae los archivos del mod en la carpeta ~mods',
          },
          {
            en: 'Go to Steam, Right-Click the game, Properties. Now, in General -> Additional Parameters, write -fileopenlog',
            es: 'Ve a Steam, haz clic derecho en el juego, Propiedades. Ahora, en General -> Parámetros adicionales de lanzamiento, escribe -fileopenlog',
          },
        ],
      },
      changelog: [
        {
          ...
          changes: [
            {
              en: "Fixed Issue where after a cutscene in Chapter 2, there wouldn't be any voices for the majority of the game.",
              es: 'Se corrigió un problema por el que, tras una cinemática en el Capítulo 2, no había voces durante la mayor parte del juego.',
            },
            {
              en: "Fixed Crashes (like when talking to Angeal's Mother).",
              es: 'Se corrigieron crashes (como al hablar con la madre de Angeal).',
            },
            {
              en: 'Fixed Fast Cutscenes with no sound.',
              es: 'Se corrigieron cinemáticas rápidas sin sonido.',
            },
            {
              en: 'Existing Save Games now work.',
              es: 'Las partidas guardadas existentes ahora funcionan.',
            },
          ],
        },
        {
    ...
    },
    {
      ...
      downloadInfo: {
        ...
        installation: [
          {
            en: 'Copy memstick folder to your PPSSPP folder, say overwrite if prompted.',
            es: 'Copia la carpeta memstick a tu carpeta de PPSSPP, acepta sobrescribir si se te solicita.',
          },
          {
            en: 'Inside the emulator, go to Settings -> Controls -> Control mapping, configure your pad: RightAn.*',
            es: 'Dentro del emulador, ve a Ajustes -> Controles -> Mapeo de controles, configura tu mando: RightAn.*',
          },
        ],
      },
      changelog: [
  ...
  tools: [
    {
      ...
      features: [
        { en: 'Convert .wav files to HCA format', es: 'Convierte archivos .wav al formato HCA' },
        {
          en: 'Replace HCA audio in .awb/.uasset files',
          es: 'Reemplaza audio HCA en archivos .awb/.uasset',
        },
        { en: 'Command-line interface', es: 'Interfaz de línea de comandos' },
      ],
      changelog: [
        {
          version: '0.1',
